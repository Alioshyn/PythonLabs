...
class Book:
    ...
    def __str__(self):
        return 'Book ID = ' + str(self.__book_id) + \
               '; Book Name  = ' + self.__book_name + \
               '; Book Author = ' + self.__book_author + \
               '; Book Publishing House = ' + self.__book_publishing_house + \
               '; Book year = ' + str(self.__book_year) + \
               '; Book Pages = ' + str(self.__book_pages) + \
               '; Book Price = ' + str(self.__book_price) + \
               '; Book Binding = ' + self.__book_binding_type


def create_new_book():
    book = Book()
    book.set_book_id(int(input('Enter Book Id: ')))
    book.set_book_name(input('Enter Book Name: '))
    book.set_book_author(input('Enter Book Author: '))
